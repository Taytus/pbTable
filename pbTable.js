...
(function($){
	$.fn.pbTable = function(options_user){
		...
		options = jQuery.extend(true, options_default, options_user);
		
		
		
		//Definicion de los objetos que se agregan
		var myTable = $(this);	
		var txtSearchBox = '<input id="search-tablaDatos" search-in="tablaDatos" type="search" class="form-control" placeholder="Buscar...">';
		var btnView ='<button id="btn-View" class="btn btn-success">Ver</button>';
		var btnEdit ='<button id="btn-Edit" class="btn btn-warning">Editar</button>';
		var btnDelete ='<button id="btn-Delete" class="btn btn-danger">Eliminar</button>';
		var btnNew ='<button id="btn-New" class="btn btn-primary">Nuevo</button>';
		var btnPrint = '<button id="btn-Print" class="btn btn-primary">Print</button>';
		var btnReceipt = '<button id="btn-Receipt" class="btn btn-primary">Recibo</button>';
		
		var divContainer = '<div id="' + myTable.attr('id') + '-pbToolbar' + '" class="row">';
